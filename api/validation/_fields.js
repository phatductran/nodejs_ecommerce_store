module.exports = {
    ...
    USER_FIELDS: ["username", "password","confirm_password", "email", "status", "role", "profileId"],
    ...
    STORAGE_FIELDS: ["name", "addressId", "propertyType", "capacity", "description", "status"],
    STORAGE_STATUS_VALUES: ["available", "full"],
    RESTOCK_FIELDS: ["productId", "from", "to", "amount", "action", "status"],
    RESTOCK_ACTION_VALUES: ["import", "export"],
}
